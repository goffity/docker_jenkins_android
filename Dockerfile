...
ENV PATH ${PATH}:${ANDROID_HOME}/tools:${ANDROID_HOME}/platform-tools:$ANDROID_HOME/tools/bin:$PATH

COPY android_sdk_components.env /opt/android-sdk-linux/android_sdk_components.env

RUN sdkmanager --update --verbose && yes | sdkmanager --licenses --verbose && sdkmanager --package_file=/opt/android-sdk-linux/android_sdk_components.env --verbose && rm /opt/android-sdk-linux/android_sdk_components.env
